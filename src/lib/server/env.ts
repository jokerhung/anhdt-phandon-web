...
const PLACEHOLDER_PASSWORD = "REPLACE_WITH_A_LONG_UNIQUE_PASSWORD";
...
const envSchema = z.object({
  ...
  ADMIN_PASSWORD: z
    .string()
    .min(16, "ADMIN_PASSWORD phải có ít nhất 16 ký tự")
    .refine((value) => value !== PLACEHOLDER_PASSWORD, "ADMIN_PASSWORD vẫn là giá trị placeholder"),
